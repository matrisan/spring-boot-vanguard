package com.matrixboot.vanguard.manager.infrastructure.aspect;
...
public class AspectLog {
     ...
     * 2.其他的切面引用
     */
    @Pointcut("execution(* com.matrixboot.vanguard.manager.application.service.*.*(..))")
